              ...
              <ul className="divide-y divide-gray-100">
                ...
                <li className="py-3 flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">RIICCM202E - Identify, locate and protect underground services</p>
                      <p className="text-xs text-gray-500">Third Question / Cover Page</p>
                    </div>
                  </div>
                  <button 
                    onClick={() => navigate('/underground-services-assessment')}
                    className="ml-4 flex-shrink-0 bg-blue-50 hover:bg-blue-100 text-blue-600 px-3 py-1.5 rounded text-sm font-medium transition-colors border border-blue-200"
                  >
                    Open
                  </button>
                ...
                <li className="py-3 flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">RIIWHS202E - Enter and work in confined spaces</p>
                      <p className="text-xs text-gray-500">Fourth Question / Cover Page</p>
                    </div>
                  </div>
                  <button 
                    onClick={() => navigate('/confined-space-assessment')}
                    className="ml-4 flex-shrink-0 bg-blue-50 hover:bg-blue-100 text-blue-600 px-3 py-1.5 rounded text-sm font-medium transition-colors border border-blue-200"
                  >
                    Open
                  </button>
                ...
                <li className="py-3 flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">RIIWHS204E - Work Safely at Heights</p>
                      <p className="text-xs text-gray-500">Fifth Question / Cover Page</p>
                    </div>
                  </div>
                  <button 
                    onClick={() => navigate('/work-safely-at-heights-assessment')}
                    className="ml-4 flex-shrink-0 bg-blue-50 hover:bg-blue-100 text-blue-600 px-3 py-1.5 rounded text-sm font-medium transition-colors border border-blue-200"
                  >
                    Open
                  </button>
